...
const en = {
  ...
  supplyMeta: (total, count) =>
    `${total} units predicted across ${count} districts — the 2018 forecast blends the 3-yr rolling baseline with a trend, clipped ±15%.`,
  ...
  colTier: "TIER",
  colPredictedSupply: "PREDICTED SUPPLY",
...
const hi = {
  ...
  tabLeftover: "बचा हुआ",
  supplyMeta: (total, count) =>
    `${count} जिलों में ${total} यूनिट अनुमानित — 2018 का पूर्वानुमान 3 साल की प्रवृत्ति से बना है, ±15% सीमा तक।`,
  matchedMeta: (count, total) =>
  ...
  colDistrict: "जिला",
  colTier: "स्तर",
  colPredictedSupply: "अनुमानित आपूर्ति",
...
const gu = {
  ...
  tabLeftover: "બાકી",
  supplyMeta: (total, count) =>
    `${count} જિલ્લામાં ${total} યુનિટ અનુમાનિત — 2018નો પૂર્વાનુમાન 3 વર્ષના વલણથી બને છે, ±15% મર્યાદા સુધી.`,
  matchedMeta: (count, total) =>
  ...
  colDistrict: "જિલ્લો",
  colTier: "સ્તર",
  colPredictedSupply: "અનુમાનિત પુરવઠો",
